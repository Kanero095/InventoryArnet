<x-template>
    <title>Jenis Modul</title>

    <div class="p-4 sm:ml-64">
        <div class="p-4 rounded-lg mt-16 bg-[#D9D9D933]">
            <form action="{{ route('jenismodul') }}" method="POST">
                @csrf
                {{-- header --}}
                <div>
                ...
                <div class="relative z-0 w-full mb-5 mt-5 group">
                    <input type="text" name="jenismodul" id="jenismodul"
